            ...
            <div class="table-responsive mailbox-messages">
              <table class="table table-hover table-striped">
                ...
                <tr>
                  ...
                  <td class="mailbox-subject"><b>موضوع الرسالة</b> - محتوى تصى لمعلومات و محتويات الرسالة ....
                  </td>
                ...
                <tr>
                  ...
                  <td class="mailbox-date">منذ 32 دقيقة</td>
                </tr>
                <tr>
                  <td><input type="checkbox"></td>
                  <td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-yellow"></i></a></td>
                  ...
                  <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                  <td class="mailbox-date">منذ 9 ساعات</td>
                </tr>
                <tr>
                  <td><input type="checkbox"></td>
                  <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                  ...
                  <td class="mailbox-attachment"></td>
                  <td class="mailbox-date">منذ 15 ساعة</td>
                </tr>
                <tr>
                  <td><input type="checkbox"></td>
                  <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                  ...
                  <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                  <td class="mailbox-date">بالامس</td>
                </tr>
                <tr>
                  <td><input type="checkbox"></td>
                  <td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-yellow"></i></a></td>
                  ...
                  <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                  <td class="mailbox-date">منذ 2 يوم</td>
                </tr>
                <tr>
                  <td><input type="checkbox"></td>
                  <td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-yellow"></i></a></td>
                ...
                <tr>
                  ...
                  <td class="mailbox-attachment"></td>
                  <td class="mailbox-date">1منذ 2 يوم</td>
                </tr>
                </tbody>
              </table>
              <!-- /.table -->
