  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8 margin_bottom">
        <h2 class="uppercase">مسئوليات شركة العهد</h2>
        <p class="heading_space">
            هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن التركيز على الشكل الخارجي للنص
        </p>
        <div class="media news_media">
          <div class="media-left">
            <img class="media-object border_radius" src="images/vision.jpg" alt="">
          </div>
        ...
        <div class="media news_media">
          <div class="media-left">
            <img class="media-object border_radius" src="images/mission.jpg" alt="">
          </div>
          <div class="media-body">
            <h3>مهمتنا</h3>
            <p class="bottom15">
        ...
        <div class="media news_media">
          <div class="media-left">
            <img class="media-object border_radius" src="images/target.jpg" alt="">
          </div>
          <div class="media-body">
            <h3>هدفنا</h3>
            <p class="bottom15">
      ...
      <div class="col-sm-4 margin_bottom">
        <h2 class="uppercase"> من نحن؟</h2>
        <p class="heading_space">هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة.</p>
        <div id="" class="">
          <div class="">
            <div class="image bottom15">
              <img src="images/about.jpg" alt="" class="border_radius">
            </div>
